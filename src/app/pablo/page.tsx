    ...
    <>
      ...
      <main>
        <PricingHero
          ...
          description="Operations and AI assistance for teams that ship real systems. Start free, scale when you need more, and only pay for the capacity you actually use."
        />
